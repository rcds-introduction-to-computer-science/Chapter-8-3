# Chapter-8-3
Separate following code into tabs, then Rewrite the following code to include two Zoogs.

Can you vary their appearance? Behavior? Consider adding color as a Zoog variable.
